...
bar file:                   user.run_rpc_command("workbench.files.action.showActiveFileInExplorer")
bar collapse:               user.run_rpc_command("workbench.files.action.collapseExplorerFolders")
