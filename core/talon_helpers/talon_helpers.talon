...
talon print <user.phrase> actions: print(" \n{user.talon_get_actions_search(phrase)}")
...
talon copy <user.phrase> actions: clip.set_text(user.talon_get_actions_search(phrase))
